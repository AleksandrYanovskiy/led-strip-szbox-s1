...
+5В подключается к выводу 5V через диод (красный провод на схеме далее), общий вывод подключается к выводу GND (черный провод на схеме далее).\
...
Всегда можно всё вернуть "как было", простым отключением модуля **Digispark**.\
Из плюсов - появилась возможность добавить любой эффект самостоятельно.